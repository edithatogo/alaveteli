...
| Persisted/generated URLs | 7 | Public-body, citation, blog and application action URLs | Fingerprint baseline; retain existing model/admin trust boundary and require separate URL-policy work if that boundary changes. |
...
The 21 current fingerprints are enumerated in `config/brakeman.ignore`. This
